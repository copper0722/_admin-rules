...
| **DKD pathophysiology + natural history (mechanism-deep)** | **Brenner & Rector's The Kidney 12e Ch41 — Diabetic Kidney Disease (Alicic / Neumiller / Merscher / Fornoni / Tuttle)** | **Specific niche** (Copper 2026-05-07 「這是重點」): nephrology gold-standard chapter; epidemiology + biomarkers + structural pathology (GBM, mesangial, podocyte, Kimmelstiel-Wilson) + multi-axis pathophysiology (hemodynamic + metabolic + AGE/RAGE + PKC + polyol + hexosamine + pro-inflammatory + fibrotic) + treatment evidence (LEADER / DAPA-CKD / CREDENCE / FIDELIO / FIGARO / FLOW). Anchor source for any DKD mechanism / staging / pathology / biomarker question. | Pure DM-clinical scope without renal angle (use Williams Ch33); Taiwan-NHI-specific (use TWDKD) |
| **DKD clinical management + screening + 共照網 routing** | ADA 2026 §11 (CKD and Risk Mgmt) + TWDKD 2024 (Taiwan-specific clinical guideline) + Brenner Ch41 (mechanism overlay) + Williams 15e Ch33 (DM-related complications) | ADA = drug class + staging recommendation; TWDKD = Taiwan-specific NHI / 共照網 routing; Brenner = pathology overlay; Williams = endocrine integrate | Pure mechanism (use Brenner + Harper); drug-only (use Washington Manual) |
