...
(g) Textbooks in topic tree directly: `{topic}/{textbook_key}_{ChNN}.md` (Phase-4 schema, post-flatten 2026-04-26). **`_textbooks/` retired** (was source-bin; violated dir=topic).
